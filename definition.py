...
def stats_viewer(dataframe):
    ...
    stats_viewer_df = dataframe[['game_date','pa','ab','hit','walk','strikeout','avg','obp','slg','ops','exit_velocity','launch_angleX','hit_spin_rate','weak','topped','under','flare','solid_contact','barrel']]
    stats_viewer_df = stats_viewer_df.rename(columns={'game_year':'구분','game_date':'경기수','pa':'타석','ab':'타수','hit':'안타','walk':'볼넷','strikeout':'삼진','avg':'타율','obp':'출루율','slg':'장타율','ops':'OPS',
                                                        'exit_velocity':'타구속도','launch_angleX':'발사각도','hit_spin_rate':'타구스핀량','weak':'Weak','topped':'Topped','under':'Under','flare':'Flare','solid_contact':'Solid Contact','barrel':'Barrel'})
...
def stats_viewer_pthrows(dataframe):
    ...
    stats_viewer_pthrows_df = dataframe[['p_throws','game_date','pa','ab','hit','walk','strikeout','avg','obp','slg','ops','exit_velocity','launch_angleX','hit_spin_rate','weak','topped','under','flare','solid_contact','barrel']]
...
def stats_viewer_pkind(dataframe):
    ...
    stats_viewer_pkind_df = dataframe[['p_kind','game_date','pa','ab','hit','walk','strikeout','avg','obp','slg','ops','exit_velocity','launch_angleX','hit_spin_rate','weak','topped','under','flare','solid_contact','barrel']]
...
def stats_viewer_pitchname(dataframe):
    ...
    stats_viewer_pitchname_df = dataframe[['pitch_name','game_date','pa','ab','hit','walk','strikeout','avg','obp','slg','ops','exit_velocity','launch_angleX','hit_spin_rate','weak','topped','under','flare','solid_contact','barrel']]
